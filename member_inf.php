...
<head>
	...
	<link rel="stylesheet" href="member_css/member.css"/>
...
<div id="grad">
        ...
        <div class="header-bar-warp d-flex">
				...
				<nav class="top-nav-area w-100">
					<div class="user-panel">
						<a href="login.html">登入</a> / <a href="register.html">注册</a>
					</div>
					<!-- Menu -->
					<ul class="main-menu primary-menu">
						<li><a href="index.html">首页</a></li>
						<li><a href="member_intro.php">战队成员</a></li>
							<li><a href="">关于我们</a></li>
	...
	<?php
		...
		$id = intval($_GET['id']);
		$result = mysqli_query($con,"Select * from information where If_ID=$id");
	...
	<!-- Page top section -->
	<a href="member_intro.php" class="button_previous">&laquo; Back</a>
	...
	<div class="whole_container">
		<div class="whole_container_left">
			...
			<div class='top_container'>
				...
				<div class="a">
				<a class="button" href="" onclick="test()">英雄高光时刻</a>
				<script>
				function test(){
					var x = "<?php echo $user_information['video_path']; ?>";
					if (x == ""){
						alert("用户未上传任何高光时刻！");
					}
				}
