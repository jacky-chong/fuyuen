...
if ($_FILES["photo"]["size"] == 0){
    $sql1 = "INSERT INTO information (User_ID, Hero_Path1, Hero_Path2, Hero_Path3, Hero_Path4, Range_H1,
    Range_H2, Range_H3, Range_H4, Name, Age, Gender, 
    contact, Team_Position, Range_General, Range_Team, 
    Message, Hero_Position_1, Hero_Position_2, Available_Time_1, Available_Time_2, Patner, 
    Hero_Displaypath, H_Picture_Path, H_Gif_Path, Photo_Path) 
    VALUES ('$id','$user_he_1','$user_he_2','$user_he_3','$user_he_4','$user_hero_1',
    '$user_hero_2','$user_hero_3','$user_hero_4','$user_name','$user_age','$user_gender',
    '$user_contact', '队员', '$user_range_general', '$user_range_team',
    '$user_message','$user_hero_position_1','$user_hero_position_2','$user_available_time_1','$user_available_time_2','$user_patner',
    '$user_hero_show','$user_hero_picturepath','$user_hero_videopath', 'img/person.png')";
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["photo"]["tmp_name"], $target_file)) {
                ...
                $sql = "INSERT INTO information (User_ID, Hero_Path1, Hero_Path2, Hero_Path3, Hero_Path4, Range_H1,
                Range_H2, Range_H3, Range_H4, Name, Age, Gender, 
                contact, Team_Position, Range_General, Range_Team, 
                Message, Hero_Position_1, Hero_Position_2, Available_Time_1, Available_Time_2, Patner, 
                Hero_Displaypath, H_Picture_Path, H_Gif_Path, Photo_Path) 
                ...
                '$user_contact', '队员', '$user_range_general', '$user_range_team',
                '$user_message','$user_hero_position_1','$user_hero_position_2','$user_available_time_1','$user_available_time_2','$user_patner',
                '$user_hero_show','$user_hero_picturepath','$user_hero_videopath', '$target_file')";
            mysqli_set_charset($con, 'utf8');
